...
MOTS_EXCLUSION = ['impôt', 'fiscal', 'fraude', 'évasion', 'prélèvement', 'budget', "don d'organe", 'soins', 'patient', 'rgpd', 'données personnelles', 'cookie', 'internet', 'téléphonique', 'commercial', 'démarchage', 'outrage à agent', 'outrage à magistrat', 'outrage au drapeau', 'rébellion', 'violation', 'violer la loi', 'en violation']
SEUIL_TRI = 3
